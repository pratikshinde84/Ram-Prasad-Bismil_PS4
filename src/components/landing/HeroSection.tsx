    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 py-20">
        ...
        >
          ...
          >
            Practice with AI-driven mock interviews tailored to your domain. 
            Get real-time feedback, detailed scoring, and a personalized roadmap to success.
          </motion.p>
          ...
          >
            <Button variant="hero" size="xl" onClick={onStartInterview}>
          ...
          >
            {[
              { icon: Brain, title: "Adaptive AI", desc: "Questions evolve based on your answers" },
              { icon: Target, title: "Domain Specific", desc: "Tailored to your career field" },
              { icon: TrendingUp, title: "Detailed Reports", desc: "Actionable insights & roadmap" },
            ].map((feature, i) => (
              <motion.div
                key={feature.title}
                initial={{ opacity: 0, y: 20 }}
